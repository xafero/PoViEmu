...
namespace PoViEmu.Tests
{
    ...
    {
        [Theory]
        [InlineData(0x69, 0x96, 0x06, 0xFF, 0xD8, 0x8F)]
        [InlineData(0x69, 0x96, 0x72, 0xFC, 0x50, 0x34)]
        [InlineData(0x69, 0xB3, 0x48, 0x7B, 0x96, 0x00)] 
        [InlineData(0x69, 0xB3, 0x58, 0xED, 0x48, 0x08)]
