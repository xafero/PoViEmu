        ...
        public void Execute(XInstruction instruct, MachineState m)
        {
            ...
            switch (parsed.Mnemonic)
            {
                ...
                case Mnemonic.Loop:
                    ...
                    break;
                case Mnemonic.Loope: break;
                case Mnemonic.Loopne: break;
                case Mnemonic.Mov:
                    if (ops is [R16, U16])
                    {
                        return; /* TODO */
                ...
                case Mnemonic.Sahf:
                    ...
                    break;
                case Mnemonic.Sal: break;
                case Mnemonic.Salc: break;
                case Mnemonic.Sar:
                    if (ops is [R16, R8])
                    {
                        return; /* TODO */
