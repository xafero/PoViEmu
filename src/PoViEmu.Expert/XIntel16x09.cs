    ...
    internal static class Intel16x09
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x80:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.AX]);
                case 0x81:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.DI).Signed(s.NextShort(buff)), R.AX]);
                case 0x82:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.SI).Signed(s.NextShort(buff)), R.AX]);
                case 0x83:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.AX]);
                case 0x84:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.AX]);
                case 0x85:
                    return new(pos, first, 4, O.or, [R.DI.Signed(s.NextShort(buff)), R.AX]);
                case 0x88:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Plus(s.NextByte(buff)), R.CX]);
                case 0x89:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.DI).Signed(s.NextShort(buff)), R.CX]);
                case 0x8A:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.SI).Signed(s.NextShort(buff)), R.CX]);
                case 0x8B:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.CX]);
                case 0x8C:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.CX]);
                case 0x8D:
                    return new(pos, first, 4, O.or, [R.DI.Signed(s.NextShort(buff)), R.CX]);
                case 0x8E:
                    return new(pos, first, 4, O.or, [R.BP.Signed(s.NextShort(buff)), R.CX]);
                case 0x90:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.DX]);
                case 0x91:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.DI).Signed(s.NextShort(buff)), R.DX]);
                case 0x92:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.SI).Signed(s.NextShort(buff)), R.DX]);
                case 0x93:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.DX]);
                case 0x94:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.DX]);
                case 0x95:
                    return new(pos, first, 4, O.or, [R.DI.Signed(s.NextShort(buff)), R.DX]);
                case 0x96:
                    return new(pos, first, 4, O.or, [R.BP.Signed(s.NextShort(buff)), R.DX]);
                case 0x97:
                    return new(pos, first, 4, O.or, [R.BX.Signed(s.NextShort(buff)), R.DX]);
                case 0x98:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.BX]);
                case 0x9A:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.SI).Signed(s.NextShort(buff)), R.BX]);
                case 0x9B:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.BX]);
                case 0x9C:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.BX]);
                case 0x9E:
                    return new(pos, first, 4, O.or, [R.BP.Signed(s.NextShort(buff)), R.BX]);
                case 0x9F:
                    return new(pos, first, 4, O.or, [R.BX.Signed(s.NextShort(buff)), R.BX]);
                case 0xA0:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.SP]);
                case 0xA1:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.DI).Signed(s.NextShort(buff)), R.SP]);
                case 0xA2:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.SI).Signed(s.NextShort(buff)), R.SP]);
                case 0xA3:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.SP]);
                case 0xA4:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.SP]);
                case 0xA5:
                    return new(pos, first, 4, O.or, [R.DI.Signed(s.NextShort(buff)), R.SP]);
                case 0xA6:
                    return new(pos, first, 4, O.or, [R.BP.Signed(s.NextShort(buff)), R.SP]);
                case 0xA7:
                    return new(pos, first, 4, O.or, [R.BX.Signed(s.NextShort(buff)), R.SP]);
                case 0xA8:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.BP]);
                case 0xA9:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.DI).Signed(s.NextShort(buff)), R.BP]);
                case 0xAA:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.SI).Signed(s.NextShort(buff)), R.BP]);
                case 0xAB:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.BP]);
                case 0xAC:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.BP]);
                case 0xAD:
                    return new(pos, first, 4, O.or, [R.DI.Signed(s.NextShort(buff)), R.BP]);
                case 0xAE:
                    return new(pos, first, 4, O.or, [R.BP.Signed(s.NextShort(buff)), R.BP]);
                case 0xAF:
                    return new(pos, first, 4, O.or, [R.BX.Signed(s.NextShort(buff)), R.BP]);
                case 0xB0:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.SI]);
                case 0xB1:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.DI).Signed(s.NextShort(buff)), R.SI]);
                case 0xB2:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.SI).Signed(s.NextShort(buff)), R.SI]);
                case 0xB3:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.SI]);
                case 0xB4:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.SI]);
                case 0xB5:
                    return new(pos, first, 4, O.or, [R.DI.Signed(s.NextShort(buff)), R.SI]);
                case 0xB6:
                    return new(pos, first, 4, O.or, [R.BP.Signed(s.NextShort(buff)), R.SI]);
                case 0xB7:
                    return new(pos, first, 4, O.or, [R.BX.Signed(s.NextShort(buff)), R.SI]);
                case 0xB8:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.DI]);
                case 0xB9:
                    return new(pos, first, 4, O.or, [R.BX.Plus(R.DI).Signed(s.NextShort(buff)), R.DI]);
                case 0xBB:
                    return new(pos, first, 4, O.or, [R.BP.Plus(R.DI).Signed(s.NextShort(buff)), R.DI]);
                case 0xBC:
                    return new(pos, first, 4, O.or, [R.SI.Signed(s.NextShort(buff)), R.DI]);
                case 0xBD:
                    return new(pos, first, 4, O.or, [R.DI.Signed(s.NextShort(buff)), R.DI]);
                case 0xBE:
                    return new(pos, first, 4, O.or, [R.BP.Signed(s.NextShort(buff)), R.DI]);
                case 0xBF:
                    return new(pos, first, 4, O.or, [R.BX.Signed(s.NextShort(buff)), R.DI]);
                case 0xC1:
