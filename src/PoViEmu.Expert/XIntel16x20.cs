    ...
    internal static class Intel16x20
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x44:
                    return new(pos, first, 3, O.and, [R.SI.Signed(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x45:
                    return new(pos, first, 3, O.and, [R.DI.Signed(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x46:
                    return new(pos, first, 3, O.and, [R.BP.Signed(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x47:
                    return new(pos, first, 3, O.and, [R.BX.Signed(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x49:
                ...
                case 0x4D:
                    return new(pos, first, 3, O.and, [R.DI.Signed(s.NextByte(buff)), R.CL],   [ second ]  );
                case 0x4E:
                ...
                case 0x54:
                    return new(pos, first, 3, O.and, [R.SI.Signed(s.NextByte(buff)), R.DL],   [ second ]  );
                case 0x55:
                    return new(pos, first, 3, O.and, [R.DI.Minus(s.NextByte(buff)), R.DL],   [ second ]  );
                case 0x56:
                    return new(pos, first, 3, O.and, [R.BP.Signed(s.NextByte(buff)), R.DL],   [ second ]  );
                case 0x57:
                ...
                case 0x5C:
                    return new(pos, first, 3, O.and, [R.SI.Signed(s.NextByte(buff)), R.BL],   [ second ]  );
                case 0x5E:
                    return new(pos, first, 3, O.and, [R.BP.Signed(s.NextByte(buff)), R.BL],   [ second ]  );
                case 0x5F:
                    return new(pos, first, 3, O.and, [R.BX.Signed(s.NextByte(buff)), R.BL],   [ second ]  );
                case 0x61:
                ...
                case 0x64:
                    return new(pos, first, 3, O.and, [R.SI.Signed(s.NextByte(buff)), R.AH],   [ second ]  );
                case 0x65:
                    return new(pos, first, 3, O.and, [R.DI.Signed(s.NextByte(buff)), R.AH],   [ second ]  );
                case 0x66:
                    return new(pos, first, 3, O.and, [R.BP.Signed(s.NextByte(buff)), R.AH],   [ second ]  );
                case 0x67:
                ...
                case 0x6C:
                    return new(pos, first, 3, O.and, [R.SI.Signed(s.NextByte(buff)), R.CH],   [ second ]  );
                case 0x6D:
                    return new(pos, first, 3, O.and, [R.DI.Signed(s.NextByte(buff)), R.CH],   [ second ]  );
                case 0x6E:
                    return new(pos, first, 3, O.and, [R.BP.Signed(s.NextByte(buff)), R.CH],   [ second ]  );
                case 0x6F:
                    return new(pos, first, 3, O.and, [R.BX.Signed(s.NextByte(buff)), R.CH],   [ second ]  );
                case 0x70:
                ...
                case 0x76:
                    return new(pos, first, 3, O.and, [R.BP.Signed(s.NextByte(buff)), R.DH],   [ second ]  );
                case 0x77:
                    return new(pos, first, 3, O.and, [R.BX.Signed(s.NextByte(buff)), R.DH],   [ second ]  );
                case 0x78:
                ...
                case 0x7C:
                    return new(pos, first, 3, O.and, [R.SI.Signed(s.NextByte(buff)), R.BH],   [ second ]  );
                case 0x7D:
                    return new(pos, first, 3, O.and, [R.DI.Signed(s.NextByte(buff)), R.BH],   [ second ]  );
                case 0x7E:
                    return new(pos, first, 3, O.and, [R.BP.Signed(s.NextByte(buff)), R.BH],   [ second ]  );
                case 0x7F:
                    return new(pos, first, 3, O.and, [R.BX.Signed(s.NextByte(buff)), R.BH],   [ second ]  );
                case 0x80:
                ...
                case 0xA0:
                    return new(pos, first, 4, O.and, [R.BX.Plus(R.SI).Signed(s.NextShort(buff)), R.AH],   [ second ]  );
                case 0xA1:
