    ...
    internal static class Intel16x20
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x40:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.SI).Plus(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x41:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.DI).Plus(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x42:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.SI).Plus(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x43:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.DI).Plus(s.NextByte(buff)), R.AL],   [ second ]  );
                case 0x44:
                ...
                case 0x49:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.DI).Plus(s.NextByte(buff)), R.CL],   [ second ]  );
                case 0x4A:
                ...
                case 0x50:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.SI).Plus(s.NextByte(buff)), R.DL],   [ second ]  );
                case 0x51:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.DI).Plus(s.NextByte(buff)), R.DL],   [ second ]  );
                case 0x52:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.SI).Plus(s.NextByte(buff)), R.DL],   [ second ]  );
                case 0x53:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.DI).Plus(s.NextByte(buff)), R.DL],   [ second ]  );
                case 0x54:
                ...
                case 0x58:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.SI).Plus(s.NextByte(buff)), R.BL],   [ second ]  );
                case 0x59:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.DI).Plus(s.NextByte(buff)), R.BL],   [ second ]  );
                case 0x5B:
                ...
                case 0x61:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.DI).Plus(s.NextByte(buff)), R.AH],   [ second ]  );
                case 0x62:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.SI).Plus(s.NextByte(buff)), R.AH],   [ second ]  );
                case 0x63:
                ...
                case 0x68:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.SI).Plus(s.NextByte(buff)), R.CH],   [ second ]  );
                case 0x6A:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.SI).Plus(s.NextByte(buff)), R.CH],   [ second ]  );
                case 0x6B:
                ...
                case 0x70:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.SI).Plus(s.NextByte(buff)), R.DH],   [ second ]  );
                case 0x71:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.DI).Plus(s.NextByte(buff)), R.DH],   [ second ]  );
                case 0x72:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.SI).Minus(s.NextByte(buff)), R.DH],   [ second ]  );
                case 0x73:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.DI).Plus(s.NextByte(buff)), R.DH],   [ second ]  );
                case 0x74:
                ...
                case 0x78:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.SI).Plus(s.NextByte(buff)), R.BH],   [ second ]  );
                case 0x79:
                    return new(pos, first, 3, O.and, [R.BX.Plus(R.DI).Plus(s.NextByte(buff)), R.BH],   [ second ]  );
                case 0x7A:
                    return new(pos, first, 3, O.and, [R.BP.Plus(R.SI).Plus(s.NextByte(buff)), R.BH],   [ second ]  );
                case 0x7B:
