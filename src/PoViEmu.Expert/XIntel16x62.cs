    ...
    internal static class Intel16x62
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x42:
                    return new(pos, first, 3, O.bound, [R.AX, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x43:
                    return new(pos, first, 3, O.bound, [R.AX, R.BP.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x44:
                    return new(pos, first, 3, O.bound, [R.AX, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x45:
                    return new(pos, first, 3, O.bound, [R.AX, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x46:
                    return new(pos, first, 3, O.bound, [R.AX, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x47:
                    return new(pos, first, 3, O.bound, [R.AX, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x48:
                    return new(pos, first, 3, O.bound, [R.CX, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x49:
                    return new(pos, first, 3, O.bound, [R.CX, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4A:
                    return new(pos, first, 3, O.bound, [R.CX, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4B:
                    return new(pos, first, 3, O.bound, [R.CX, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4C:
                    return new(pos, first, 3, O.bound, [R.CX, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4D:
                    return new(pos, first, 3, O.bound, [R.CX, R.DI.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x4E:
                    return new(pos, first, 3, O.bound, [R.CX, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4F:
                    return new(pos, first, 3, O.bound, [R.CX, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x50:
                    return new(pos, first, 3, O.bound, [R.DX, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x51:
                    return new(pos, first, 3, O.bound, [R.DX, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x52:
                ...
                case 0x54:
                    return new(pos, first, 3, O.bound, [R.DX, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x55:
                    return new(pos, first, 3, O.bound, [R.DX, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x56:
                    return new(pos, first, 3, O.bound, [R.DX, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x57:
                    return new(pos, first, 3, O.bound, [R.DX, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x58:
                    return new(pos, first, 3, O.bound, [R.BX, R.BX.Plus(R.SI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x59:
                    return new(pos, first, 3, O.bound, [R.BX, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5A:
                    return new(pos, first, 3, O.bound, [R.BX, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5B:
                    return new(pos, first, 3, O.bound, [R.BX, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5D:
                    return new(pos, first, 3, O.bound, [R.BX, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5E:
                    return new(pos, first, 3, O.bound, [R.BX, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5F:
                    return new(pos, first, 3, O.bound, [R.BX, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x60:
                    return new(pos, first, 3, O.bound, [R.SP, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x61:
                    return new(pos, first, 3, O.bound, [R.SP, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x62:
                    return new(pos, first, 3, O.bound, [R.SP, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x63:
                    return new(pos, first, 3, O.bound, [R.SP, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x64:
                    return new(pos, first, 3, O.bound, [R.SP, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x65:
                    return new(pos, first, 3, O.bound, [R.SP, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x67:
                    return new(pos, first, 3, O.bound, [R.SP, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x68:
                    return new(pos, first, 3, O.bound, [R.BP, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x69:
                    return new(pos, first, 3, O.bound, [R.BP, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6A:
                    return new(pos, first, 3, O.bound, [R.BP, R.BP.Plus(R.SI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x6B:
                    return new(pos, first, 3, O.bound, [R.BP, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6C:
                    return new(pos, first, 3, O.bound, [R.BP, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6D:
                    return new(pos, first, 3, O.bound, [R.BP, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6E:
                    return new(pos, first, 3, O.bound, [R.BP, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6F:
                    return new(pos, first, 3, O.bound, [R.BP, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x70:
                    return new(pos, first, 3, O.bound, [R.SI, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x71:
                    return new(pos, first, 3, O.bound, [R.SI, R.BX.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x72:
                    return new(pos, first, 3, O.bound, [R.SI, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x73:
                    return new(pos, first, 3, O.bound, [R.SI, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x74:
                    return new(pos, first, 3, O.bound, [R.SI, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x75:
                    return new(pos, first, 3, O.bound, [R.SI, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x76:
                    return new(pos, first, 3, O.bound, [R.SI, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x77:
                    return new(pos, first, 3, O.bound, [R.SI, R.BX.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x78:
                    return new(pos, first, 3, O.bound, [R.DI, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x79:
                    return new(pos, first, 3, O.bound, [R.DI, R.BX.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x7A:
                    return new(pos, first, 3, O.bound, [R.DI, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x7B:
                    return new(pos, first, 3, O.bound, [R.DI, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x7C:
                    return new(pos, first, 3, O.bound, [R.DI, R.SI.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x7E:
                    return new(pos, first, 3, O.bound, [R.DI, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x7F:
                    return new(pos, first, 3, O.bound, [R.DI, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x80:
