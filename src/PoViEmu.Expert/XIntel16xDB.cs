    ...
    internal static class Intel16xDB
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x45:
                    return new(pos, first, 3, O.fild, [M.dword.On(R.DI.Signed(s.NextByte(buff)))], [second]);
                case 0x46:
                    return new(pos, first, 3, O.fild, [M.dword.On(R.BP.Minus(s.NextByte(buff)))], [second]);
                case 0x47:
                    return new(pos, first, 3, O.fild, [M.dword.On(R.BX.Signed(s.NextByte(buff)))], [second]);
                case 0x48:
                ...
                case 0x4F:
                    return new(pos, first, 3, O.fisttp, [M.dword.On(R.BX.Signed(s.NextByte(buff)))], [second]);
                case 0x50:
                ...
                case 0x54:
                    return new(pos, first, 3, O.fist, [M.dword.On(R.SI.Signed(s.NextByte(buff)))], [second]);
                case 0x55:
                    return new(pos, first, 3, O.fist, [M.dword.On(R.DI.Signed(s.NextByte(buff)))], [second]);
                case 0x56:
                    return new(pos, first, 3, O.fist, [M.dword.On(R.BP.Signed(s.NextByte(buff)))], [second]);
                case 0x57:
                    return new(pos, first, 3, O.fist, [M.dword.On(R.BX.Signed(s.NextByte(buff)))], [second]);
                case 0x58:
                ...
                case 0x5D:
                    return new(pos, first, 3, O.fistp, [M.dword.On(R.DI.Signed(s.NextByte(buff)))], [second]);
                case 0x5E:
                    return new(pos, first, 3, O.fistp, [M.dword.On(R.BP.Signed(s.NextByte(buff)))], [second]);
                case 0x5F:
                ...
                case 0x6D:
                    return new(pos, first, 3, O.fld, [M.tword.On(R.DI.Signed(s.NextByte(buff)))], [second]);
                case 0x6E:
                    return new(pos, first, 3, O.fld, [M.tword.On(R.BP.Signed(s.NextByte(buff)))], [second]);
                case 0x6F:
                    return new(pos, first, 3, O.fld, [M.tword.On(R.BX.Signed(s.NextByte(buff)))], [second]);
                case 0x78:
                ...
                case 0x7C:
                    return new(pos, first, 3, O.fstp, [M.tword.On(R.SI.Signed(s.NextByte(buff)))], [second]);
                case 0x7D:
                    return new(pos, first, 3, O.fstp, [M.tword.On(R.DI.Signed(s.NextByte(buff)))], [second]);
                case 0x7E:
                    return new(pos, first, 3, O.fstp, [M.tword.On(R.BP.Signed(s.NextByte(buff)))], [second]);
                case 0x7F:
