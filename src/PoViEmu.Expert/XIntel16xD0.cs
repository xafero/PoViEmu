    ...
    internal static class Intel16xD0
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x40:
                    return new(pos, first, 3, O.rol, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x42:
                    return new(pos, first, 3, O.rol, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x43:
                    return new(pos, first, 3, O.rol, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x45:
                    return new(pos, first, 3, O.rol, [M.@byte.On(R.DI.Minus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x46:
                    return new(pos, first, 3, O.rol, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x47:
                    return new(pos, first, 3, O.rol, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x48:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x49:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x4A:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x4B:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x4C:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x4D:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x4E:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x4F:
                    return new(pos, first, 3, O.ror, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x51:
                    return new(pos, first, 3, O.rcl, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x52:
                ...
                case 0x54:
                    return new(pos, first, 3, O.rcl, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x55:
                    return new(pos, first, 3, O.rcl, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x56:
                    return new(pos, first, 3, O.rcl, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x57:
                    return new(pos, first, 3, O.rcl, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x58:
                    return new(pos, first, 3, O.rcr, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x59:
                    return new(pos, first, 3, O.rcr, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x5A:
                    return new(pos, first, 3, O.rcr, [M.@byte.On(R.BP.Plus(R.SI).Minus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x5B:
                    return new(pos, first, 3, O.rcr, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x5C:
                    return new(pos, first, 3, O.rcr, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x5D:
                    return new(pos, first, 3, O.rcr, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x5E:
                ...
                case 0x62:
                    return new(pos, first, 3, O.shl, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x63:
                    return new(pos, first, 3, O.shl, [M.@byte.On(R.BP.Plus(R.DI).Minus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x64:
                    return new(pos, first, 3, O.shl, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x65:
                    return new(pos, first, 3, O.shl, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x66:
                    return new(pos, first, 3, O.shl, [M.@byte.On(R.BP.Minus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x67:
                    return new(pos, first, 3, O.shl, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x68:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.BX.Plus(R.SI).Minus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x69:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x6A:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x6B:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x6C:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x6D:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x6E:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x6F:
                    return new(pos, first, 3, O.shr, [M.@byte.On(R.BX.Minus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x79:
                    return new(pos, first, 3, O.sar, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x7A:
                    return new(pos, first, 3, O.sar, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x7B:
                    return new(pos, first, 3, O.sar, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x7C:
                    return new(pos, first, 3, O.sar, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x7D:
                    return new(pos, first, 3, O.sar, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x7E:
                    return new(pos, first, 3, O.sar, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0x80:
                ...
                case 0xAF:
                    return new(pos, first, 4, O.shr, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), C.One)],   [ second ]  );
                case 0xB8:
