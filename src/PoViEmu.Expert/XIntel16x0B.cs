    ...
    internal static class Intel16x0B
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x82:
                    return new(pos, first, 4, O.or, [R.AX, R.BP.Plus(R.SI).Minus(s.NextShort(buff))]);
                case 0x83:
                    return new(pos, first, 4, O.or, [R.AX, R.BP.Plus(R.DI).Minus(s.NextShort(buff))]);
                case 0x84:
                    return new(pos, first, 4, O.or, [R.AX, R.SI.Minus(s.NextShort(buff))]);
                case 0x85:
                    return new(pos, first, 4, O.or, [R.AX, R.DI.Minus(s.NextShort(buff))]);
                case 0x86:
                    return new(pos, first, 4, O.or, [R.AX, R.BP.Plus(s.NextShort(buff))]);
                case 0x87:
                    return new(pos, first, 4, O.or, [R.AX, R.BX.Plus(s.NextShort(buff))]);
                case 0x88:
                    return new(pos, first, 4, O.or, [R.CX, R.BX.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0x89:
                    return new(pos, first, 4, O.or, [R.CX, R.BX.Plus(R.DI).Plus(s.NextShort(buff))]);
                case 0x8A:
                    return new(pos, first, 4, O.or, [R.CX, R.BP.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0x8B:
                    return new(pos, first, 4, O.or, [R.CX, R.BP.Plus(R.DI).Minus(s.NextShort(buff))]);
                case 0x8C:
                    return new(pos, first, 4, O.or, [R.CX, R.SI.Plus(s.NextShort(buff))]);
                case 0x8D:
                    return new(pos, first, 4, O.or, [R.CX, R.DI.Plus(s.NextShort(buff))]);
                case 0x8E:
                    return new(pos, first, 4, O.or, [R.CX, R.BP.Plus(s.NextShort(buff))]);
                case 0x8F:
                    return new(pos, first, 4, O.or, [R.CX, R.BX.Minus(s.NextShort(buff))]);
                case 0x90:
                    return new(pos, first, 4, O.or, [R.DX, R.BX.Plus(R.SI).Minus(s.NextShort(buff))]);
                case 0x92:
                    return new(pos, first, 4, O.or, [R.DX, R.BP.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0x93:
                    return new(pos, first, 4, O.or, [R.DX, R.BP.Plus(R.DI).Plus(s.NextShort(buff))]);
                case 0x94:
                    return new(pos, first, 4, O.or, [R.DX, R.SI.Plus(s.NextShort(buff))]);
                case 0x95:
                    return new(pos, first, 4, O.or, [R.DX, R.DI.Plus(s.NextShort(buff))]);
                case 0x96:
                    return new(pos, first, 4, O.or, [R.DX, R.BP.Minus(s.NextShort(buff))]);
                case 0x97:
                    return new(pos, first, 4, O.or, [R.DX, R.BX.Minus(s.NextShort(buff))]);
                case 0x98:
                    return new(pos, first, 4, O.or, [R.BX, R.BX.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0x99:
                    return new(pos, first, 4, O.or, [R.BX, R.BX.Plus(R.DI).Minus(s.NextShort(buff))]);
                case 0x9A:
                    return new(pos, first, 4, O.or, [R.BX, R.BP.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0x9B:
                    return new(pos, first, 4, O.or, [R.BX, R.BP.Plus(R.DI).Plus(s.NextShort(buff))]);
                case 0x9C:
                    return new(pos, first, 4, O.or, [R.BX, R.SI.Minus(s.NextShort(buff))]);
                case 0x9E:
                    return new(pos, first, 4, O.or, [R.BX, R.BP.Plus(s.NextShort(buff))]);
                case 0x9F:
                    return new(pos, first, 4, O.or, [R.BX, R.BX.Plus(s.NextShort(buff))]);
                case 0xA0:
                    return new(pos, first, 4, O.or, [R.SP, R.BX.Plus(R.SI).Minus(s.NextShort(buff))]);
                case 0xA1:
                    return new(pos, first, 4, O.or, [R.SP, R.BX.Plus(R.DI).Minus(s.NextShort(buff))]);
                case 0xA2:
                    return new(pos, first, 4, O.or, [R.SP, R.BP.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0xA3:
                    return new(pos, first, 4, O.or, [R.SP, R.BP.Plus(R.DI).Plus(s.NextByte(buff))]);
                case 0xA4:
                    return new(pos, first, 4, O.or, [R.SP, R.SI.Minus(s.NextShort(buff))]);
                case 0xA5:
                    return new(pos, first, 4, O.or, [R.SP, R.DI.Plus(s.NextShort(buff))]);
                case 0xA6:
                    return new(pos, first, 4, O.or, [R.SP, R.BP.Plus(s.NextShort(buff))]);
                case 0xA8:
                    return new(pos, first, 4, O.or, [R.BP, R.BX.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0xA9:
                    return new(pos, first, 4, O.or, [R.BP, R.BX.Plus(R.DI).Plus(s.NextShort(buff))]);
                case 0xAB:
                    return new(pos, first, 4, O.or, [R.BP, R.BP.Plus(R.DI).Plus(s.NextShort(buff))]);
                case 0xAC:
                    return new(pos, first, 4, O.or, [R.BP, R.SI.Plus(s.NextShort(buff))]);
                case 0xAD:
                    return new(pos, first, 4, O.or, [R.BP, R.DI.Plus(s.NextShort(buff))]);
                case 0xAE:
                    return new(pos, first, 4, O.or, [R.BP, R.BP.Plus(s.NextShort(buff))]);
                case 0xAF:
                    return new(pos, first, 4, O.or, [R.BP, R.BX.Plus(s.NextShort(buff))]);
                case 0xB0:
                    return new(pos, first, 4, O.or, [R.SI, R.BX.Plus(R.SI).Plus(s.NextShort(buff))]);
                case 0xB1:
                    return new(pos, first, 4, O.or, [R.SI, R.BX.Plus(R.DI).Plus(s.NextShort(buff))]);
                case 0xB2:
                    return new(pos, first, 4, O.or, [R.SI, R.BP.Plus(R.SI).Minus(s.NextShort(buff))]);
                case 0xB3:
                    return new(pos, first, 4, O.or, [R.SI, R.BP.Plus(R.DI).Minus(s.NextShort(buff))]);
                case 0xB4:
                    return new(pos, first, 4, O.or, [R.SI, R.SI.Plus(s.NextShort(buff))]);
                case 0xB5:
                    return new(pos, first, 4, O.or, [R.SI, R.DI.Plus(s.NextShort(buff))]);
                case 0xB6:
                    return new(pos, first, 4, O.or, [R.SI, R.BP.Minus(s.NextShort(buff))]);
                case 0xB7:
                    return new(pos, first, 4, O.or, [R.SI, R.BX.Minus(s.NextShort(buff))]);
                case 0xB8:
                    return new(pos, first, 4, O.or, [R.DI, R.BX.Plus(R.SI).Minus(s.NextShort(buff))]);
                case 0xB9:
                    return new(pos, first, 4, O.or, [R.DI, R.BX.Plus(R.DI).Plus(s.NextShort(buff))]);
                case 0xBA:
                    return new(pos, first, 4, O.or, [R.DI, R.BP.Plus(R.SI).Minus(s.NextShort(buff))]);
                case 0xBB:
                    return new(pos, first, 4, O.or, [R.DI, R.BP.Plus(R.DI).Minus(s.NextShort(buff))]);
                case 0xBC:
                    return new(pos, first, 4, O.or, [R.DI, R.SI.Plus(s.NextShort(buff))]);
                case 0xBD:
                    return new(pos, first, 4, O.or, [R.DI, R.DI.Minus(s.NextShort(buff))]);
                case 0xBE:
                    return new(pos, first, 4, O.or, [R.DI, R.BP.Minus(s.NextShort(buff))]);
                case 0xC0:
