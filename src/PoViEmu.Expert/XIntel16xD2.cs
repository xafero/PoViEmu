    ...
    internal static class Intel16xD2
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x80:
                    return new(pos, first, 4, O.rol, [M.@byte.On(R.BX.Plus(R.SI).Minus(s.NextShort(buff))), R.CL]);
                case 0x81:
                    return new(pos, first, 4, O.rol, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextShort(buff))), R.CL]);
                case 0x82:
                    return new(pos, first, 4, O.rol, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextShort(buff))), R.CL]);
                case 0x85:
                    return new(pos, first, 4, O.rol, [M.@byte.On(R.DI.Minus(s.NextShort(buff)), R.CL)]);
                case 0x86:
                    return new(pos, first, 4, O.rol, [M.@byte.On(R.BP.Plus(s.NextShort(buff)), R.CL)]);
                case 0x89:
                    return new(pos, first, 4, O.ror, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextShort(buff))), R.CL]);
                case 0x8B:
                    return new(pos, first, 4, O.ror, [M.@byte.On(R.BP.Plus(R.DI).Minus(s.NextShort(buff))), R.CL]);
                case 0x8C:
                    return new(pos, first, 4, O.ror, [M.@byte.On(R.SI.Plus(s.NextShort(buff)), R.CL)]);
                case 0x8D:
                    return new(pos, first, 4, O.ror, [M.@byte.On(R.DI.Minus(s.NextShort(buff)), R.CL)]);
                case 0x8E:
                    return new(pos, first, 4, O.ror, [M.@byte.On(R.BP.Minus(s.NextShort(buff)), R.CL)]);
                case 0x8F:
                    return new(pos, first, 4, O.ror, [M.@byte.On(R.BX.Minus(s.NextShort(buff)), R.CL)]);
                case 0x90:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextShort(buff))), R.CL]);
                case 0x91:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.BX.Plus(R.DI).Minus(s.NextShort(buff))), R.CL]);
                case 0x92:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.BP.Plus(R.SI).Minus(s.NextShort(buff))), R.CL]);
                case 0x93:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextShort(buff))), R.CL]);
                case 0x94:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.SI.Minus(s.NextShort(buff)), R.CL)]);
                case 0x95:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.DI.Plus(s.NextShort(buff)), R.CL)]);
                case 0x96:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.BP.Minus(s.NextShort(buff)), R.CL)]);
                case 0x97:
                    return new(pos, first, 4, O.rcl, [M.@byte.On(R.BX.Plus(s.NextShort(buff)), R.CL)]);
                case 0x98:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.BX.Plus(R.SI).Minus(s.NextShort(buff))), R.CL]);
                case 0x99:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextShort(buff))), R.CL]);
                case 0x9A:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.BP.Plus(R.SI).Minus(s.NextShort(buff))), R.CL]);
                case 0x9B:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.BP.Plus(R.DI).Minus(s.NextShort(buff))), R.CL]);
                case 0x9C:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.SI.Minus(s.NextShort(buff)), R.CL)]);
                case 0x9D:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.DI.Minus(s.NextShort(buff)), R.CL)]);
                case 0x9E:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.BP.Plus(s.NextShort(buff)), R.CL)]);
                case 0x9F:
                    return new(pos, first, 4, O.rcr, [M.@byte.On(R.BX.Minus(s.NextShort(buff)), R.CL)]);
                case 0xA0:
                    return new(pos, first, 4, O.shl, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextShort(buff))), R.CL]);
                case 0xA1:
                    return new(pos, first, 4, O.shl, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextShort(buff))), R.CL]);
                case 0xA2:
                    return new(pos, first, 4, O.shl, [M.@byte.On(R.BP.Plus(R.SI).Minus(s.NextShort(buff))), R.CL]);
                case 0xA4:
                    return new(pos, first, 4, O.shl, [M.@byte.On(R.SI.Plus(s.NextShort(buff)), R.CL)]);
                case 0xA5:
                    return new(pos, first, 4, O.shl, [M.@byte.On(R.DI.Plus(s.NextShort(buff)), R.CL)]);
                case 0xA6:
                    return new(pos, first, 4, O.shl, [M.@byte.On(R.BP.Plus(s.NextShort(buff)), R.CL)]);
                case 0xA7:
                    return new(pos, first, 4, O.shl, [M.@byte.On(R.BX.Plus(s.NextShort(buff)), R.CL)]);
                case 0xA8:
                    return new(pos, first, 4, O.shr, [M.@byte.On(R.BX.Plus(R.SI).Minus(s.NextShort(buff))), R.CL]);
                case 0xAA:
                    return new(pos, first, 4, O.shr, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextShort(buff))), R.CL]);
                case 0xAB:
                    return new(pos, first, 4, O.shr, [M.@byte.On(R.BP.Plus(R.DI).Minus(s.NextShort(buff))), R.CL]);
                case 0xAE:
                    return new(pos, first, 4, O.shr, [M.@byte.On(R.BP.Minus(s.NextShort(buff)), R.CL)]);
                case 0xAF:
                    return new(pos, first, 4, O.shr, [M.@byte.On(R.BX.Minus(s.NextShort(buff)), R.CL)]);
                case 0xB8:
                    return new(pos, first, 4, O.sar, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextShort(buff))), R.CL]);
                case 0xB9:
                    return new(pos, first, 4, O.sar, [M.@byte.On(R.BX.Plus(R.DI).Minus(s.NextShort(buff))), R.CL]);
                case 0xBA:
                    return new(pos, first, 4, O.sar, [M.@byte.On(R.BP.Plus(R.SI).Minus(s.NextShort(buff))), R.CL]);
                case 0xBB:
                    return new(pos, first, 4, O.sar, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextShort(buff))), R.CL]);
                case 0xBC:
                    return new(pos, first, 4, O.sar, [M.@byte.On(R.SI.Plus(s.NextShort(buff)), R.CL)]);
                case 0xBD:
                    return new(pos, first, 4, O.sar, [M.@byte.On(R.DI.Plus(s.NextShort(buff)), R.CL)]);
                case 0xBF:
                    return new(pos, first, 4, O.sar, [M.@byte.On(R.BX.Plus(s.NextShort(buff)), R.CL)]);
                case 0xC0:
