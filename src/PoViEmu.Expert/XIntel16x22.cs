    ...
    internal static class Intel16x22
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x41:
                    return new(pos, first, 3, O.and, [R.AL, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x42:
                    return new(pos, first, 3, O.and, [R.AL, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x43:
                    return new(pos, first, 3, O.and, [R.AL, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x44:
                    return new(pos, first, 3, O.and, [R.AL, R.SI.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x45:
                    return new(pos, first, 3, O.and, [R.AL, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x46:
                    return new(pos, first, 3, O.and, [R.AL, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x47:
                    return new(pos, first, 3, O.and, [R.AL, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4A:
                    return new(pos, first, 3, O.and, [R.CL, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4B:
                    return new(pos, first, 3, O.and, [R.CL, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4C:
                    return new(pos, first, 3, O.and, [R.CL, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4D:
                    return new(pos, first, 3, O.and, [R.CL, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4E:
                    return new(pos, first, 3, O.and, [R.CL, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x4F:
                    return new(pos, first, 3, O.and, [R.CL, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x50:
                    return new(pos, first, 3, O.and, [R.DL, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x51:
                    return new(pos, first, 3, O.and, [R.DL, R.BX.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x52:
                    return new(pos, first, 3, O.and, [R.DL, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x53:
                    return new(pos, first, 3, O.and, [R.DL, R.BP.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x54:
                    return new(pos, first, 3, O.and, [R.DL, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x55:
                    return new(pos, first, 3, O.and, [R.DL, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x56:
                    return new(pos, first, 3, O.and, [R.DL, R.BP.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x58:
                    return new(pos, first, 3, O.and, [R.BL, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x59:
                    return new(pos, first, 3, O.and, [R.BL, R.BX.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x5A:
                    return new(pos, first, 3, O.and, [R.BL, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5B:
                    return new(pos, first, 3, O.and, [R.BL, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5C:
                    return new(pos, first, 3, O.and, [R.BL, R.SI.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x5D:
                    return new(pos, first, 3, O.and, [R.BL, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x5E:
                ...
                case 0x60:
                    return new(pos, first, 3, O.and, [R.AH, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x61:
                    return new(pos, first, 3, O.and, [R.AH, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x62:
                    return new(pos, first, 3, O.and, [R.AH, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x63:
                    return new(pos, first, 3, O.and, [R.AH, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x64:
                    return new(pos, first, 3, O.and, [R.AH, R.SI.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x65:
                    return new(pos, first, 3, O.and, [R.AH, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x67:
                    return new(pos, first, 3, O.and, [R.AH, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x68:
                    return new(pos, first, 3, O.and, [R.CH, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x69:
                    return new(pos, first, 3, O.and, [R.CH, R.BX.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x6A:
                    return new(pos, first, 3, O.and, [R.CH, R.BP.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6B:
                    return new(pos, first, 3, O.and, [R.CH, R.BP.Plus(R.DI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x6C:
                    return new(pos, first, 3, O.and, [R.CH, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6D:
                    return new(pos, first, 3, O.and, [R.CH, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6E:
                    return new(pos, first, 3, O.and, [R.CH, R.BP.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x6F:
                    return new(pos, first, 3, O.and, [R.CH, R.BX.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x70:
                    return new(pos, first, 3, O.and, [R.DH, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x71:
                    return new(pos, first, 3, O.and, [R.DH, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x72:
                ...
                case 0x74:
                    return new(pos, first, 3, O.and, [R.DH, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x75:
                    return new(pos, first, 3, O.and, [R.DH, R.DI.Minus(s.NextByte(buff))],   [ second ]  );
                case 0x78:
                    return new(pos, first, 3, O.and, [R.BH, R.BX.Plus(R.SI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x79:
                    return new(pos, first, 3, O.and, [R.BH, R.BX.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x7A:
                    return new(pos, first, 3, O.and, [R.BH, R.BP.Plus(R.SI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0x7B:
                    return new(pos, first, 3, O.and, [R.BH, R.BP.Plus(R.DI).Plus(s.NextByte(buff))],   [ second ]  );
                case 0x7C:
                    return new(pos, first, 3, O.and, [R.BH, R.SI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x7D:
                    return new(pos, first, 3, O.and, [R.BH, R.DI.Plus(s.NextByte(buff))],   [ second ]  );
                case 0x80:
                ...
                case 0xA2:
                    return new(pos, first, 4, O.and, [R.AH, R.BP.Plus(R.SI).Minus(s.NextByte(buff))],   [ second ]  );
                case 0xA3:
