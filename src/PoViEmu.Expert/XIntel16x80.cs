    ...
    internal static class Intel16x80
    {
        internal static Instruction? Parse(Stream s, byte[] buff, long pos, byte first)
        {
            ...
            switch (second)
            {
                ...
                case 0x40:
                    return new(pos, first, 4, O.add, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x41:
                    return new(pos, first, 4, O.add, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x42:
                ...
                case 0x44:
                    return new(pos, first, 4, O.add, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x45:
                    return new(pos, first, 4, O.add, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x46:
                    return new(pos, first, 4, O.add, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x47:
                    return new(pos, first, 4, O.add, [M.@byte.On(R.BX.Minus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x48:
                    return new(pos, first, 4, O.or, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x49:
                    return new(pos, first, 4, O.or, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x4A:
                    return new(pos, first, 4, O.or, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x4B:
                    return new(pos, first, 4, O.or, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x4D:
                    return new(pos, first, 4, O.or, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x4E:
                    return new(pos, first, 4, O.or, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x4F:
                    return new(pos, first, 4, O.or, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x50:
                    return new(pos, first, 4, O.adc, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x51:
                    return new(pos, first, 4, O.adc, [M.@byte.On(R.BX.Plus(R.DI).Minus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x52:
                    return new(pos, first, 4, O.adc, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x53:
                    return new(pos, first, 4, O.adc, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x55:
                    return new(pos, first, 4, O.adc, [M.@byte.On(R.DI.Minus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x56:
                    return new(pos, first, 4, O.adc, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x58:
                    return new(pos, first, 4, O.sbb, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x59:
                    return new(pos, first, 4, O.sbb, [M.@byte.On(R.BX.Plus(R.DI).Minus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x5A:
                    return new(pos, first, 4, O.sbb, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x5C:
                    return new(pos, first, 4, O.sbb, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x5D:
                    return new(pos, first, 4, O.sbb, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x5E:
                    return new(pos, first, 4, O.sbb, [M.@byte.On(R.BP.Minus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x5F:
                    return new(pos, first, 4, O.sbb, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x60:
                    return new(pos, first, 4, O.and, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x61:
                    return new(pos, first, 4, O.and, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x62:
                ...
                case 0x64:
                    return new(pos, first, 4, O.and, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x65:
                    return new(pos, first, 4, O.and, [M.@byte.On(R.DI.Minus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x66:
                    return new(pos, first, 4, O.and, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x67:
                    return new(pos, first, 4, O.and, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x68:
                    return new(pos, first, 4, O.sub, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x69:
                    return new(pos, first, 4, O.sub, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x6A:
                    return new(pos, first, 4, O.sub, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x6B:
                    return new(pos, first, 4, O.sub, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x6C:
                    return new(pos, first, 4, O.sub, [M.@byte.On(R.SI.Minus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x6D:
                    return new(pos, first, 4, O.sub, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x6E:
                    return new(pos, first, 4, O.sub, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x70:
                    return new(pos, first, 4, O.xor, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x71:
                    return new(pos, first, 4, O.xor, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x72:
                    return new(pos, first, 4, O.xor, [M.@byte.On(R.BP.Plus(R.SI).Minus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x74:
                    return new(pos, first, 4, O.xor, [M.@byte.On(R.SI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x75:
                    return new(pos, first, 4, O.xor, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x76:
                    return new(pos, first, 4, O.xor, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x77:
                    return new(pos, first, 4, O.xor, [M.@byte.On(R.BX.Minus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x78:
                    return new(pos, first, 4, O.cmp, [M.@byte.On(R.BX.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x79:
                    return new(pos, first, 4, O.cmp, [M.@byte.On(R.BX.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x7A:
                    return new(pos, first, 4, O.cmp, [M.@byte.On(R.BP.Plus(R.SI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x7B:
                    return new(pos, first, 4, O.cmp, [M.@byte.On(R.BP.Plus(R.DI).Plus(s.NextByte(buff))), s.NextByte(buff)],   [ second ]  );
                case 0x7D:
                    return new(pos, first, 4, O.cmp, [M.@byte.On(R.DI.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x7E:
                    return new(pos, first, 4, O.cmp, [M.@byte.On(R.BP.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x7F:
                    return new(pos, first, 4, O.cmp, [M.@byte.On(R.BX.Plus(s.NextByte(buff)), s.NextByte(buff))],   [ second ]  );
                case 0x80:
